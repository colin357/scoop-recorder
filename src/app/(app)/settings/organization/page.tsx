  ...
  return (
    <div className="space-y-6 max-w-2xl">
      <div>
        ...
        <p className="text-sm text-slate-500">Admins only. Recording behaviour, review, retention, and where notifications go.</p>
      </div>
      <form action={updateOrgSettingsAction} className="space-y-6">
        ...
        <section className="card p-5 grid gap-3">
          ...
          <label className="flex items-start gap-3 font-normal">
            ...
            <span><span className="font-medium text-slate-900 block">Review AI tasks before teammates are notified</span><span className="text-sm text-slate-500">Generated tasks stay as drafts on the meeting page until an admin approves them. Admins still get the summary right away.</span></span>
          </label>
        </section>
        ...
        <section className="card p-5 grid gap-3">
          ...
          <label className="flex items-start gap-3 font-normal">
            ...
            <span><span className="font-medium text-slate-900 block">Announce the recording in the meeting chat when the bot joins</span><span className="text-sm text-slate-500">Recommended. Tells participants the call is being recorded and how to opt out.</span></span>
          </label>
          <div>
            ...
            <p className="text-xs text-slate-500 mt-1">Summaries and tasks are kept. Media is removed from storage nightly once older than this.</p>
          </div>
        </section>
        ...
        <section className="card p-5 grid gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500 mt-1">Slack → Apps → Incoming Webhooks → Add to channel. Teammates can add their Slack member ID on their profile to get @mentioned.</p>
          </div>
          <div>
            ...
            <p className="text-xs text-slate-500 mt-1">Teams channel → ⋯ → Workflows → “Post to a channel when a webhook request is received”.</p>
          </div>
        </section>
